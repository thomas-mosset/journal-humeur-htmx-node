...
// GET HOMEPAGE W/ FORM AND EMOJIS
router.get('/', async (req, res) => {
    try {
        // Get emojis before creating the page
...
// GET A SPECIFIC MOOD
router.get('/moods/edit/:id', async (req, res) => {
...
// CHART PIE
router.get('/moods/chart', (req, res) => {
    ...
    db.all(query, [], (err, rows) => {
        ...
        // Convert into an array [{ mood: "☺️", count: 3 }, ...]
...
// EXPORT JSON
router.get('/moods/export-json', (req, res) => {
    const query = `SELECT * FROM moods`;
...
// EXPORT CSV
router.get('/moods/export-csv', (req, res) => {
    const query = `SELECT * FROM moods`;
...
// ADD EMOJI TO FORM INPUT
router.post('/select-emoji', (req, res) => {
